...
const ReferencesPage: React.FC = () => {
  return (
    <PageWrapper>
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">References & Acknowledgements</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-lg">Canadian Provinces GeoJSON</h3>
            <p className="text-gray-700">
              The GeoJSON data for Canadian provinces and territories used in the interactive map visualization.
            </p>
            <p className="text-sm text-gray-600 mt-2">
              Source: <a href="https://github.com/Mahshadn/canadian_map" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">Mahshadn/canadian_map</a> on GitHub
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-lg">Canadian Species Index (CSI)</h3>
            <p className="text-gray-700">
          ...
          <div>
            <h3 className="font-semibold text-lg">CAN-SAR Database</h3>
            <p className="text-gray-700">
